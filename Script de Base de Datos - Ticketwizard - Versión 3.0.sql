...
(1, 1, 800.00, DATE_ADD(CURDATE(), INTERVAL 7 DAY)), -- Primer boleto a la venta
(1, 2, 800.00, DATE_ADD(CURDATE(), INTERVAL 7 DAY)), -- Segundo boleto a la venta
(1, 3, 800.00, DATE_ADD(CURDATE(), INTERVAL 7 DAY)); -- Tercer boleto a la venta
